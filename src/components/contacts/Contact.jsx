...
const Contact = () => {
    ...
    const isInView = useInView(ref, { rootMargin: "-50px 0px" })
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_a12k14o', 'template_n6acqw9', formRef.current, '1uHiL8ht-PXEXae9t')
            .then((result) => {
                setSuccess(true);
            }, (error) => {
                setError(true);
